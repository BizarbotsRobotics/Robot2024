...
class Intake(commands2.Subsystem):
    ...
    def __init__(self):
        ...
        self.pivotMotorOne = MotorController(MotorControllerType.FALCON, MotorType.BRUSHLESS, IntakeConstants.PIVOT_MOTOR_1)
        self.pivotMotorTwo = MotorController(MotorControllerType.FALCON, MotorType.BRUSHLESS, IntakeConstants.PIVOT_MOTOR_2)
